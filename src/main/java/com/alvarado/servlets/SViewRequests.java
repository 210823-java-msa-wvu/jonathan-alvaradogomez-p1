...
public class SViewRequests extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        System.out.println("\nSViewRequests received a " + request.getMethod() + " request at " + request.getRequestURI());
        log.trace("SViewRequests Accessed");
