...
public class SuperAddInfoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        System.out.println("\nSuperAddInfoServlet received a " + request.getMethod() + " request at " + request.getRequestURI());
        log.trace("SuperAddInfoServlet Accessed");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        // Log when this servlet has been accessed
        System.out.println("\nSuperAddInfoServlet Servlet received a " + request.getMethod() + " request at " + request.getRequestURI());
        log.trace("SuperAddInfoServlet Servlet Accessed");
        ...
        a.setSuperMoreInfo(true);
        System.out.println("super_more_info was set to true");
...
//        log.trace("Form Data Successfully received from user: " + session.getAttribute("username"));
        ...
        response.sendRedirect("superAddInfo.html");
