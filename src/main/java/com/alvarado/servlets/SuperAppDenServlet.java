...
public class SuperAppDenServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        System.out.println("\nSuperAppDenServlet received a " + request.getMethod() + " request at " + request.getRequestURI());
        log.trace("SuperAppDenServlet Accessed");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        // Log when this servlet has been accessed
        System.out.println("\nSuperAppDenServlet Servlet received a " + request.getMethod() + " request at " + request.getRequestURI());
        log.trace("SuperAppDenServlet Servlet Accessed");
        ...
        a.setSuperDecision(decision);
        a.setSuperReasoning(reason);
        ...
        response.sendRedirect("superAppDen.html");
