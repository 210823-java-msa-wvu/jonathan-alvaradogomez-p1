...
public class HeadViewRequests extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        System.out.println("\nHeadViewRequests received a " + request.getMethod() + " request at " + request.getRequestURI());
        log.trace("HeadViewRequests Accessed");
