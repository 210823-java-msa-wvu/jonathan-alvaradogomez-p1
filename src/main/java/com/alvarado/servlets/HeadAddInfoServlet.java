...
public class HeadAddInfoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        System.out.println("\nHeadAddInfoServlet received a " + request.getMethod() + " request at " + request.getRequestURI());
        log.trace("HeadAddInfoServlet Accessed");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        // Log when this servlet has been accessed
        System.out.println("\nHeadAddInfoServlet Servlet received a " + request.getMethod() + " request at " + request.getRequestURI());
        log.trace("HeadAddInfoServlet Servlet Accessed");
        ...
        a.setHeadMoreInfo(true);
        System.out.println("head_more_info was set to true");
...
//        log.trace("Form Data Successfully received from user: " + session.getAttribute("username"));
        ...
        response.sendRedirect("headAddInfo.html");
