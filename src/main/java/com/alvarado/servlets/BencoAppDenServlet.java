...
public class BencoAppDenServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        System.out.println("\nBencoAppDenServlet received a " + request.getMethod() + " request at " + request.getRequestURI());
        log.trace("BencoAppDenServlet Accessed");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        // Log when this servlet has been accessed
        System.out.println("\nBencoAppDenServlet Servlet received a " + request.getMethod() + " request at " + request.getRequestURI());
        log.trace("BencoAppDenServlet Servlet Accessed");
        ...
        a.setBencoDecision(decision);
        a.setBencoReasoning(reason);
        ...
        response.sendRedirect("bencoAppDen.html");
