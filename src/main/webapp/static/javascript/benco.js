...
let baseURL  = `http://localhost:8080/Project1/static/benco?` ;
...
function populateData(res){
    ...
    item1.innerHTML = `<a href="bencoViewRequests.html">View Submitted Requests</a>`;
    ol.appendChild(item1);

    ol.appendChild(document.createElement("br"));

    let item2 = document.createElement("li");
    item2.innerHTML = `<a href="bencoAddInfo.html">Request Additional Information</a>`;
    ol.appendChild(item2);

    ol.appendChild(document.createElement("br"));

    let item3 = document.createElement("li");
    item3.innerHTML = `<a href="bencoAppDen.html">Approve or Deny a Request</a>`;
    ol.appendChild(item3);

    ol.appendChild(document.createElement("br"));

    let item4 = document.createElement("li");
    item4.innerHTML = `<a href="moneyMatters.html">Change Request Amount</a>`;
