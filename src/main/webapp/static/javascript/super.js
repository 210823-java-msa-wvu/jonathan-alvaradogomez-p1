...
let baseURL  = `http://localhost:8080/Project1/static/super?` ;
...
function populateData(res){
    ...
    item1.innerHTML = `<a href="sViewRequests.html">View Submitted Requests</a>`;
    ol.appendChild(item1);

    ol.appendChild(document.createElement("br"));

    let item2 = document.createElement("li");
    item2.innerHTML = `<a href="superAddInfo.html">Request Additional Information</a>`;
    ol.appendChild(item2);

    ol.appendChild(document.createElement("br"));

    let item3 = document.createElement("li");
    item3.innerHTML = `<a href="superAppDen.html">Approve or Deny a Request</a>`;
    ...
    // let item3 = document.createElement("li");
    // item3.innerHTML = `<a href="employeeAddInfo.html">Request Additional Information</a>`;
    // ol.appendChild(item3);
