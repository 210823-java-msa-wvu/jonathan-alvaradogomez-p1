...
let baseURL  = `http://localhost:8080/Project1/static/headAddInfo?` ;
...
function populateData(res, index) {
    ...
    let contentsArray = [approvalId, staffId, finalGrade, staffMoreInfo, headDecision, headReasoning];
    ...
    if (staffMoreInfo == "" && headMoreInfo == false){

        //create a form element
        let infoForm = document.createElement("form");
        infoForm.setAttribute("action","headAddInfo");
    ...
    } else if (staffMoreInfo == "" && headMoreInfo == true){
