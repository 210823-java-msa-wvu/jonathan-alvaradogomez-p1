...
let baseURL  = `http://localhost:8080/Project1/static/superAddInfo?` ;
...
function populateData(res, index) {
    ...
    let contentsArray = [approvalId, staffId, finalGrade, staffMoreInfo, superDecision, superReasoning];
    ...
    if (staffMoreInfo == "" && superMoreInfo == false){

        //create a form element
        let infoForm = document.createElement("form");
        infoForm.setAttribute("action","superAddInfo");
    ...
    } else if (staffMoreInfo == "" && superMoreInfo == true){
